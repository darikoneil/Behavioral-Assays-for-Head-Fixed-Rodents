...
class HardConfig:
    ...
    def __init__(self):
        ...
        # Reward Sucrose
        self.sucrose_reward_channel_name = "BurrowDAQ/port0/line1" # Checked
        self.sucrose_reward_channel_id = int(1)
        # Reward Water
        self.water_reward_channel_name = "BurrowDAQ/port0/line2" # Checked
        self.water_reward_channel_id = int(2)
        # Licking Sucrose
        self.licking_sucrose_channel_name = "BurrowDAQ/port0/line3" # Checked
        self.licking_sucrose_channel_id = int(3)
        # Licking Water
        self.licking_water_channel_name = "BurrowDAQ/port0/line4" # Checked
        ...
        self.motor_channel = "BurrowDAQ/ao0" # Checked
        ...
        self.num_digital_out_port_2 = int(1)
        self.digital_chans_out_port_2 = "BurrowDAQ/port2/line0"
        # Gate Driver
        ...
        self.permission_water_channel_name = "BurrowDAQ/port1/line0" # Checked
        self.permission_water_channel_id = int(0)
        # Sucrose Reward Permission
        self.permission_sucrose_channel_name = "BurrowDAQ/port1/line1" # Checked
        ...
        # Flag Wet Starts
        self.wet_start_channel_name = "BurrowDAQ/port2/line0"
