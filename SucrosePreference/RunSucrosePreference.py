...
from SucrosePreferenceMachine import SucrosePreferenceTask
...
from Scratch.HardwareConfiguration import HardConfig
...
class DAQtoBurrow(Task):
    ...
    def __init__(self, *args):
        ...
        # Import Sucrose Preference Configuration
        if args:
            self.sucrose_preference_config = SucrosePreferenceConfig(args[0])
        else:
        ...
        # Instance Behavior
        self.sucrose_preference_machine = SucrosePreferenceTask(self.sucrose_preference_config)
    ...
    def EveryNCallback(self):
        self.sucrose_preference_machine.proceed_sync = True
        ...
        # Parse States
        if self.current_state != self.sucrose_preference_machine.state:
            self.current_state = self.sucrose_preference_machine.state
        ...
        self.sucrose_preference_machine.proceed_sync = False
